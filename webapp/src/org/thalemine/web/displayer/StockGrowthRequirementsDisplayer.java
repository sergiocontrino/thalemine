...
public class StockGrowthRequirementsDisplayer extends ReportDisplayer
{
	
	private static final String STOCK_SERVICE = "StockQueryService";
	protected static final Logger log = Logger.getLogger(StockGrowthRequirementsDisplayer.class);
     ...
     */
    public StockGrowthRequirementsDisplayer(ReportDisplayerConfig config, InterMineAPI im) {
        super(config, im);
    }
