...
public class GenotypeDAOImpl implements QueryRepository, GenotypeDAO, Verifiable {
	...
	protected static final Logger log = Logger.getLogger(GenotypeDAOImpl.class);
	
	public GenotypeDAOImpl(){
		super();
	}
