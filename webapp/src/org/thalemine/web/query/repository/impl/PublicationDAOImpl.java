...
public class PublicationDAOImpl implements QueryRepository, PublicationDAO, Verifiable {
	...
	protected static final Logger log = Logger.getLogger(PublicationDAOImpl.class);
