...
import org.thalemine.web.database.core.ItemCountAware;
...
public abstract class AbstractItemCountingItemStreamItemReader<T> extends AbstractItemStreamItemReader<T> {
	...
	protected static final Logger log = Logger.getLogger(AbstractItemCountingItemStreamItemReader.class);
