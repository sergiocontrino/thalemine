...
<!-- genotypeStocksDisplayer.jsp -->

<c:set var="object" value="${intermineobject}" />
<c:set var="stocks" value="${object.stocks}" />
...
<div id="genotype_stocks_displayer" class="collection-table">
				...
				<tbody>
					...
					<c:forEach var="item" items="${stocks}">
						<tr>
							...
							<td class="one-line">
							<c:forEach var="bgItem" items="${item.backgroundAccessions}">

									<a href="report.do?id=${bgItem.id}">${bgItem.abbreviationName}</a>
