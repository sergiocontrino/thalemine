    ...
    <div id="tabs-controls">
      <div>
        <fieldset>
              ...
              <input type="radio" name="showInteractions" onclick="vis.filter('edges', function(edge) { return edge.color <= '#FF0000'; });" disabled><label>Genetic Interactions (<em>currently unavailable</em>)</label>
        </fieldset>
