...
<div class="header">
    ...
    <p>Data Source: <a target="_blank" href="/${WEB_PROPERTIES['webapp.path']}/portal.do?class=DataSet&externalids=BioGRID+interaction+data+set">BioGRID</a>,&nbsp;
    <a target="_blank" href="/${WEB_PROPERTIES['webapp.path']}/portal.do?class=DataSet&externalids=IntAct+interactions+data+set">IntAct</a></p>
</div>
</div>
