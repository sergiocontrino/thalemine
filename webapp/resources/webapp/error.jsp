...
<div id="errorMsg" style="display:none;">${msg}</div>
<div id="errorSubject" style="display:none;">${subject}</div>
<div id="generic_error">
  <div id="errorApology">
    <p>
      ...
      <a href="#" onclick="showContactForm(); return false">send us an email</a>
